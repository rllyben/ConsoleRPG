    ...
    internal class Program
    {
        ...
        internal static void Adventure()
        {
            ...
            */
            ...
            Monster ratmanHunter = new Monster("Ratman Hunter", "Elite Monster", 1.4F, 20, 44, 38, 30, 62);
            Monster pirate = new Monster("Pirate", "Normal Monster", 1.1F, 16, 20, 26, 16, 32);
            Monster matrose = new Monster("Matrose", "Normal Monster", 1.5F, 18, 26, 33, 38, 38);
            Monster lizardman = new Monster("Lizardman", "Normal Monster", 1.7F, 21, 34, 39, 41, 41);
            Monster mara = new Monster("Mara", "Hero Monster", 1.2F, 20, 81, 103, 84, 193);
            Monster desertRunner = new Monster("Desert Runner", "Normal Monster", 0.9F, 22, 40, 48, 33, 45);
            Monster marloneMegaton = new Monster("Marlone Megaton", "Normal Monster", 0.5F, 23, 32, 46, 31, 49);
            Monster desertSpider = new Monster("Desert Spider", "Normal Monster", 1.6F, 25, 65, 81, 43, 56);
            Monster desertLizardman = new Monster("Desert Lizardman", "Elite Monster", 1.7F, 24, 62, 74, 36, 58);
            Monster desertWorm = new Monster("Desert Worm", "Hero Monster", 2.0F, 28, 246, 386, 104, 364);
            Monster marloneFighter = new Monster("Marlone Fighter", "Normal Monster", 1.5F, 26, 75, 94, 41, 57);
            Monster marloneGeneral = new Monster("Marlone General", "Elite Monster", 1.3F, 28, 87, 108, 61, 72);
            Monster marlone = new Monster("Marlone", "Hero Monster", 1.4F, 30, 226, 342, 124, 410);
            Monster spider = new Monster("Spider", "Normal Monster", 1.6F, 31, 126, 206, 62, 82);
            Monster bat = new Monster("Bat", "Normal Monster", 1.5F, 28, 93, 128, 56, 78);
            Monster zombie = new Monster("Zombie", "Normal Monster", 1.8F, 34, 148, 241, 83, 120);
            Monster tombFox = new Monster("Tomb Fox", "Normal Monster", 0.8F, 35, 132, 215, 86, 132);
            Monster piggyBat = new Monster("Piggy Bat", "Elite Monster", 1.5F, 30, 106, 163, 68, 163);
            Monster ghostSlime = new Monster("Ghost Slime", "Hero Monster", 1.9F, 38, 571, 931, 168, 628);
            Monster babyWereBear = new Monster("Baby Werebear", "Normal Monster", 1.1F, 35, 141, 258, 101, 141);
            Monster fireVivi = new Monster("Fire Vivi", "Normal Monster", 1.4F, 38, 0, 0, 62, 164, 212, 328);
            Monster fighterSecretSociety = new Monster("Fighter of the Secret Society", "Elite Monster", 1.1F, 36, 242, 361, 132, 226);
            Monster leaderSecretSociety = new Monster("Leader of the Secret Society", "Hero Monster", 1.5F, 42, 512, 1026, 312, 816);
            Monster caveProg = new Monster("Cave Prog", "Normal Monster", 1.1F, 34, 138, 191, 81, 153);
            Monster caveBook = new Monster("Cave Magicbook", "Normal Monster", 1.5F, 37, 0, 0, 73, 181, 227, 368);
            Monster silverGolem = new Monster("Silver Golem", "Hero Monster", 2.2F, 40, 759, 1485, 56, 78);
            Monster ghost = new Monster("Ghost", "Normal Monster", 1.2F, 38, 0, 0, 121, 212, 263, 411);
            Monster boneImp = new Monster("Bone Imp", "Normal Monster", 1.9F, 40, 323, 464, 163, 231);
            Monster prog = new Monster("Prog", "Normal Monster", 1.1F, 41, 383, 523, 118, 243);
            Monster hobFighter = new Monster("Hob Fighter", "Elite Monster", 1.5F, 43, 512, 761, 236, 417);
            Monster robo = new Monster("Robo", "Hero Monster", 1.3F, 46, 1828, 2674, 622, 1818);
            Monster goblin = new Monster("Goblin", "Normal Monster", 1.3F, 43, 421, 532, 181, 262);
            Monster werebear = new Monster("Werebear", "Normal Monster", 1.1F, 45, 512, 704, 213, 281);
            Monster sandRat = new Monster("Sand Rat", "Normal Monster", 1.4F, 48, 718, 892, 234, 341);
            Monster goblinMage = new Monster("Goblin Mage", "Elite Monster", 1.6F, 46, 0, 0, 199, 612, 537, 839);
            Monster goblinGeneral = new Monster("Goblin General", "Elite Monster", 1.3F, 48, 1312, 1730, 510, 738);
            Monster goblinKing = new Monster("Goblin King", "Hero Monster", 1.4F, 50, 3870, 5643, 1126, 2389);
            Monster harkan = new Monster("Harkan", "Normal Monster", 1.5F, 49, 731, 903, 262, 368);
            Monster kingEber = new Monster("King Eber", "Normal Monster", 1.8F, 51, 812, 1135, 281, 410);
            Monster weakebndOrge = new Monster("Weakend Orge", "Normal Monster", 1.9F, 52, 1161, 1412, 412, 619);
            Monster orge = new Monster("Orge", "Elite Monster", 1.9F, 52, 1236, 1643, 482, 1619);
            Monster prisinor = new Monster("Prisonor", "Normal Monster", 1.1F, 54, 1326, 1741, 364, 628);
            Monster executioner = new Monster("Executioner", "Normal Monster", 1.5F, 56, 1672, 2138, 418, 712);
            Monster torturer = new Monster("Torturer", "Normal Monster", 1.6F, 58, 1983, 2619, 476, 829);
            Monster erzKarasianMage = new Monster("Erz Karasian Mage", "Elite Monster", 1.6F, 60, 0, 0, 481, 1262, 2162, 2873);
            Monster desharkan = new Monster("Desharkan", "Normal Monster", 1.5F, 59, 2050, 2648, 480, 869);
            Monster karasianFighter = new Monster("Karasian Fighter", "Normal Monster", 0.9F, 60, 2737, 3379, 512, 930);
            Monster karasianMage = new Monster("Karasian Mage", "Normal Monster", 1.6F, 60, 0, 0, 312, 1071, 2078, 2810);
            Monster archon = new Monster("Archon", "Normal Monster", 1.3F, 61, 2985, 3810, 548, 1280);
            Monster pixi = new Monster("Pixi", "Elite Monster", 1.5F, 65, 5380, 8173, 812, 4012);
            if (false)
            {
                roumen.IDcheck();
                tideForest.IDcheck();
